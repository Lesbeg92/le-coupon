...
Le champ "facteurs" est essentiel pour l'utilisateur: donne 4 a 6 lignes courtes et concretes, prefixees par leur theme, qui resument ce qu'il faut savoir avant le match. Couvre dans cet ordre quand l'info existe: "Forme: ..." (3 a 5 derniers resultats ou dynamique de chaque equipe), "Absents: ..." (blessures et suspensions qui comptent, sinon dis-le), "Cles: ..." (1 a 3 joueurs decisifs a surveiller), "Compo: ..." (systeme ou compo probable si connue, sinon ce qui est attendu), "Enjeu: ..." (ce que chaque equipe doit aller chercher: qualification, premiere place, etc.), "Marche: ..." (favori et ordre de grandeur des cotes, ex. "France favorite cote ~1.5"). Reste factuel et specifique a ce match, pas de generalites. Si une info manque vraiment, n'invente pas, passe la ligne.
